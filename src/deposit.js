...
// console.log(name);
        if (isNaN(deposit) || deposit < 0) {
            ...
            await axios.put(`https://servers-0ihb.onrender.com/update/${id}`, { amount: total + deposit }).then(setTotal(total + deposit)).then(alert(`amount ${deposit} is deposited successfully !`));
